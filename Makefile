...
unit_test: unit_test.o RGB_component.o image.o uarray2.o a2plain.o calculations.o CV_to_DCT.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

40image: 40image.o compression.o image.o uarray2.o a2plain.o RGB_component.o calculations.o CV_to_DCT.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
