...
unit_test: unit_test.o image.o uarray2.o a2plain.o calculations.o rgb_cv.o cv_dct.o bitpack.o packUnpack.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)

40image: 40image.o compression.o image.o uarray2.o a2plain.o calculations.o rgb_cv.o cv_dct.o bitpack.o packUnpack.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
