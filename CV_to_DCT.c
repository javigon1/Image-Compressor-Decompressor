...
void applyCv(int col, int row, A2Methods_UArray2 UArray2, void *elem, void *cl)
{
        ...
        if (col < (closure->methods->width(UArray2)) / 2 && 
            row < (closure->methods->height(UArray2)) / 2)  {
        ...
        ypbpr_pixel1->y = cw->a - cw->b - cw->c + cw->d;
        ypbpr_pixel2->y = cw->a - cw->b + cw->c + cw->d;
        ypbpr_pixel3->y = cw->a + cw->b - cw->c + cw->d;
        ypbpr_pixel4->y = cw->a + cw->b + cw->c + cw->d;
